...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_image_4 .v-src-width { width: 90% !important; } #u_content_image_4 .v-src-max-width { max-width: 90% !important; } #u_content_heading_2 .v-container-padding-padding { padding: 340px 10px 0px !important; } #u_column_6 .v-col-border { border-top: 0px solid transparent !important;border-left: 0px solid transparent !important;border-right: 0px solid transparent !important;border-bottom: 0px solid transparent !important; } #u_content_text_4 .v-container-padding-padding { padding: 40px 20px 10px !important; } #u_content_text_4 .v-font-size { font-size: 14px !important; } #u_content_text_4 .v-text-align { text-align: center !important; } #u_content_button_3 .v-button-colors { color: #FFFFFF !important; background-color: #0f446c !important; } #u_content_button_3 .v-button-colors:hover { color: #FFFFFF !important; background-color: #3AAEE0 !important; } #u_content_button_3 .v-text-align { text-align: center !important; } #u_content_button_3 .v-container-padding-padding { padding: 10px !important; } #u_column_7 .v-col-border { border-top: 0px solid transparent !important;border-left: 0px solid transparent !important;border-right: 0px solid transparent !important;border-bottom: 1px solid #7e8c8d !important; } #u_content_image_3 .v-container-padding-padding { padding: 10px 0px 40px !important; } #u_content_image_3 .v-src-width { width: auto !important; } #u_content_image_3 .v-src-max-width { max-width: 100% !important; } #u_column_4 .v-col-border { border-top: 0px solid transparent !important;border-left: 0px solid transparent !important;border-right: 0px solid transparent !important;border-bottom: 0px solid transparent !important; } #u_content_image_2 .v-container-padding-padding { padding: 40px 0px 0px !important; } #u_content_image_2 .v-src-width { width: 79% !important; } #u_content_image_2 .v-src-max-width { max-width: 79% !important; } #u_column_5 .v-col-border { border-top: 0px solid transparent !important;border-left: 0px solid transparent !important;border-right: 0px solid transparent !important;border-bottom: 1px solid #7e8c8d !important; } #u_content_text_3 .v-container-padding-padding { padding: 20px 20px 10px !important; } #u_content_text_3 .v-font-size { font-size: 14px !important; } #u_content_text_3 .v-text-align { text-align: center !important; } #u_content_button_2 .v-button-colors { color: #FFFFFF !important; background-color: #0f446c !important; } #u_content_button_2 .v-button-colors:hover { color: #FFFFFF !important; background-color: #3AAEE0 !important; } #u_content_button_2 .v-text-align { text-align: center !important; } #u_content_button_2 .v-container-padding-padding { padding: 10px 10px 40px !important; } #u_column_2 .v-col-border { border-top: 0px solid transparent !important;border-left: 0px solid transparent !important;border-right: 0px solid transparent !important;border-bottom: 0px solid transparent !important; } #u_content_text_2 .v-container-padding-padding { padding: 40px 20px 10px !important; } #u_content_text_2 .v-font-size { font-size: 14px !important; } #u_content_text_2 .v-text-align { text-align: center !important; } #u_content_button_1 .v-button-colors { color: #FFFFFF !important; background-color: #0f446c !important; } #u_content_button_1 .v-button-colors:hover { color: #FFFFFF !important; background-color: #3AAEE0 !important; } #u_content_button_1 .v-text-align { text-align: center !important; } #u_content_button_1 .v-container-padding-padding { padding: 10px !important; } #u_column_3 .v-col-border { border-top: 0px solid transparent !important;border-left: 0px solid transparent !important;border-right: 0px solid transparent !important;border-bottom: 0px solid transparent !important; } #u_content_image_1 .v-container-padding-padding { padding: 10px 10px 40px !important; } #u_content_image_1 .v-src-width { width: 92% !important; } #u_content_image_1 .v-src-max-width { max-width: 92% !important; } #u_content_social_2 .v-container-padding-padding { padding: 40px 10px 10px !important; } #u_content_text_6 .v-container-padding-padding { padding: 10px 10px 20px !important; } }
    </style>
</head>
...
<!--[if gte mso 9]>
      <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto;min-width: 320px;max-width: 600px;">
        <tr>
          <td background="{{ asset('vendor/mail-templates/halloween-deals/assets/1698670931851-1.png') }}" valign="top" width="100%">
      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width: 600px;">
        <v:fill type="frame" src="{{ asset('vendor/mail-templates/halloween-deals/assets/1698670931851-1.png') }}" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
      <![endif]-->
<div class="u-row-container" style="padding: 0px 0px 30px;background-image: url('{{ asset('vendor/mail-templates/halloween-deals/assets/1698670931851-1.png') }}');background-repeat: no-repeat;background-position: center top;background-color: transparent">
<div class="u-row" style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
<div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px 0px 30px;background-image: url('{{ asset('vendor/mail-templates/halloween-deals/assets/1698670931851-1.png') }}');background-repeat: no-repeat;background-position: center top;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: transparent;"><![endif]-->
...
<img align="center" alt="un" border="0" class="v-src-width v-src-max-width" src="{{ asset('vendor/mail-templates/halloween-deals/assets/1698730627775-png.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 50%;max-width: 290px;" title="un" width="290"/>
</td>
</tr>
</table>
</td>
...
<p style="line-height: 140%; margin: 0px;">Welcome to our special Halloween offers! Prepare for some spooktacular deals on your favorite items!</p>
</div>
</td>
</tr>
</tbody>
...
<!--[if (mso)|(IE)]><td align="center" width="285" class="v-col-border" style="background-color: #0f446c;width: 285px;padding: 0px;border-top: 0px solid transparent;border-left: 15px solid #000000;border-right: 0px solid transparent;border-bottom: 15px solid #000000;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
<div class="u-col u-col-50" id="u_column_6" style="max-width: 320px;min-width: 300px;display: table-cell;vertical-align: top;">
<div style="background-color: #0f446c;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
<!--[if (!mso)&(!IE)]><!--><div class="v-col-border" style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 15px solid #000000;border-right: 0px solid transparent;border-bottom: 15px solid #000000;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:60px 10px 10px 32px;font-family:arial,helvetica,sans-serif;">
...
<p style="line-height: 140%; margin: 0px;">Introducing our limited-time Halloween deals, exclusive to our valued customers! Take advantage of these offers before they disappear!</p>
</div>
</td>
</tr>
</tbody>
...
<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ asset('vendor/mail-templates/halloween-deals/assets/asset_2f8c5a96.bin') }}" style="height:37px; v-text-anchor:middle; width:163px;" arcsize="11%"  stroke="f" fillcolor="#dd4a36"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
<a class="v-button v-button-colors v-border v-font-size" href="{{ asset('vendor/mail-templates/halloween-deals/assets/asset_2f8c5a96.bin') }}" style="box-sizing: border-box; display: inline-block; text-decoration: none; text-size-adjust: none; text-align: center; color: rgb(255, 255, 255); background: rgb(221, 74, 54); border-radius: 4px; width: 66%; max-width: 100%; word-break: break-word; overflow-wrap: break-word; font-size: 14px; border-width: 1px; border-style: solid; border-color: rgb(221, 74, 54); line-height: inherit;" target="_blank"><span style="display:block;padding:10px 20px;line-height:120%;"><span style="line-height: 16.8px;">Shop Now<br/></span></span>
</a>
...
<!--[if (mso)|(IE)]></td><![endif]-->
<!--[if (mso)|(IE)]><td align="center" width="285" class="v-col-border" style="background-color: #0f446c;width: 285px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 15px solid #000000;border-bottom: 15px solid #000000;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
<div class="u-col u-col-50" id="u_column_7" style="max-width: 320px;min-width: 300px;display: table-cell;vertical-align: top;">
<div style="background-color: #0f446c;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
<!--[if (!mso)&(!IE)]><!--><div class="v-col-border" style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 15px solid #000000;border-bottom: 15px solid #000000;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
...
<tr>
<td align="center" class="v-text-align" style="padding-right: 0px;padding-left: 0px;">
<img align="center" alt="laravelmail" border="0" class="v-src-width v-src-max-width" src="{{ asset('vendor/mail-templates/halloween-deals/assets/1698671430706-2.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 280px;" title="laravelmail" width="280"/>
</td>
</tr>
</table>
</td>
...
<tr>
<td align="center" class="v-text-align" style="padding-right: 0px;padding-left: 0px;">
<img align="center" alt="laravelmail" border="0" class="v-src-width v-src-max-width" src="{{ asset('vendor/mail-templates/halloween-deals/assets/1698671744874-3.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 280px;" title="laravelmail" width="280"/>
</td>
</tr>
</table>
</td>
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:60px 30px 10px 10px;font-family:arial,helvetica,sans-serif;">
<div class="v-text-align v-font-size" style="font-size: 13px; color: #ffffff; line-height: 140%; text-align: left; word-wrap: break-word;">
<p style="line-height: 140%; margin: 0px;">Welcome to our exciting Halloween sale! Find incredible deals on your favorite items just in time for the spooky season.</p>
</div>
</td>
</tr>
</tbody>
...
<!--[if mso]><style>.v-button {background: transparent !important;}</style><![endif]-->
<div align="left" class="v-text-align">
<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ asset('vendor/mail-templates/halloween-deals/assets/asset_2f8c5a96.bin') }}" style="height:37px; v-text-anchor:middle; width:175px;" arcsize="11%"  stroke="f" fillcolor="#dd4a36"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
<a class="v-button v-button-colors v-border v-font-size" href="{{ asset('vendor/mail-templates/halloween-deals/assets/asset_2f8c5a96.bin') }}" style="box-sizing: border-box; display: inline-block; text-decoration: none; text-size-adjust: none; text-align: center; color: rgb(255, 255, 255); background: rgb(221, 74, 54); border-radius: 4px; width: 66%; max-width: 100%; word-break: break-word; overflow-wrap: break-word; font-size: 14px; border-width: 1px; border-style: solid; border-color: rgb(221, 74, 54); line-height: inherit;" target="_blank"><span style="display:block;padding:10px 20px;line-height:120%;"><span style="line-height: 16.8px;">Shop Now<br/></span></span>
</a>
<!--[if mso]></center></v:roundrect><![endif]-->
</div>
...
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:60px 10px 10px 32px;font-family:arial,helvetica,sans-serif;">
<div class="v-text-align v-font-size" style="font-size: 13px; color: #ffffff; line-height: 140%; text-align: left; word-wrap: break-word;">
<p style="line-height: 140%; margin: 0px;">Get ready to indulge in special Halloween offers that will brighten up your day!</p>
</div>
</td>
</tr>
</tbody>
...
<tr>
<td align="center" class="v-text-align" style="padding-right: 0px;padding-left: 0px;">
<img align="center" alt="laravelmail" border="0" class="v-src-width v-src-max-width" src="{{ asset('vendor/mail-templates/halloween-deals/assets/1698671751517-4.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 280px;" title="laravelmail" width="280"/>
</td>
</tr>
</table>
</td>
...
<tbody><tr style="vertical-align: top"><td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top" valign="middle">
<a href="{{ asset('vendor/mail-templates/halloween-deals/assets/asset_de62a5c7.bin') }}" style="color: rgb(0, 0, 238); text-decoration: underline; line-height: inherit;" target="_blank" title="X"><img alt="X" src="{{ asset('vendor/mail-templates/halloween-deals/assets/x.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="X" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<p style="font-size: 14px; line-height: 170%; margin: 0px;">Welcome to our Halloween extravaganza! Dive into a world of thrilling discounts and tantalizing treats. Don't miss out on this limited-time offer!</p>
</div>
</td>
</tr>
</tbody>
